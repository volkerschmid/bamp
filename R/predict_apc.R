...
#' to number of MCMC iterations. Quantiles will be provided for convinience, but all samples are available.
#' If population numbers are given, number of cases will also be predicted. Number of cases will not only be predicted for future periods,
#' bt also for the time periods where data are available; this can be used for model assesment.
#'
