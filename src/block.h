...
//Erzeugt standardnormalverteilten Zufallsvektor der Länge noa
void gausssample(double* temp, int noa);

//Blockupdate für APC-Modell
...
//Blockupdate für APC-Modell mit Kovariablen
...
//Blockupdate für APC-Modell mit unst. Effekten
