...
model1 <- bamp(cases, population, age="rw1", period="rw1", cohort="rw1", overdisp=TRUE,
              periods_per_agegroup = 5)
modl0 = selectModel(cases, population, periods_per_agegroup = 5, screen = list(number_of_iterations = 20000, burn_in = 10000,
                                      step = 5, tuning = 200))
```
...
```{r model3}
model3<-bamp(cases, population, age="rw1", period="rw1", cohort="rw1", overdisp = TRUE,
              periods_per_agegroup = 5)
