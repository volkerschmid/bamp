...
This site provides the legacy standalone version 1.3 of BAMP. It is no longer supported and only provided for historic reasons.
...
We recommend converting bamp.ini to unix format using [dos2unix] after editing the file with WordPad. Unpack dos2unix to the bamp folder. After editing and saving bamp.ini, drop the bamp.ini file on the dos2unix icon. After this, BAMP should run smoothly on all Windows versions.
